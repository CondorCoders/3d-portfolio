...
Command: npx gltfjsx@6.5.2 ./public/models/AvatarCreatorModel.glb --t 
*/
...
type ActionName =
  ...
  | "Armature|mixamo.com|Layer0.009"
  | "Armature|mixamo.com|Layer0.010"
  | "Armature|mixamo.com|Layer0.011"
  | "Armature|mixamo.com|Layer0.012"
  | "Armature|mixamo.com|Layer0.013"
  | "Armature|mixamo.com|Layer0.014"
  | "Armature|mixamo.com|Layer0.015"
  | "Happy"
  | "HeadNod"
  | "Standing"
  | "Thinking"
...
export function AvatarCreatorModel(props: JSX.IntrinsicElements["group"]) {
  const group = React.useRef<THREE.Group | null>(null);
  const { scene, animations } = useGLTF("/models/AvatarCreatorModel.glb");
...
useGLTF.preload("/models/AvatarCreatorModel.glb");
